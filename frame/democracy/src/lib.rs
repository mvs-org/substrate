...
use frame_support::{
    ...
    traits::{
        ...
        BalanceStatus, Currency, EnsureOrigin, Get, LockIdentifier, LockableCurrency,
        MigrateAccount, OnUnbalanced, ReservableCurrency, WithdrawReason,
    },
...
impl WeightInfo for () {
    ...
    fn emergency_cancel(_r: u32) -> Weight {
        1_000_000_000
    }
    fn external_propose(_p: u32, _v: u32) -> Weight {
        1_000_000_000
    }
    fn external_propose_majority(_p: u32) -> Weight {
        1_000_000_000
    }
    fn external_propose_default(_p: u32) -> Weight {
        1_000_000_000
    }
    fn fast_track(_p: u32) -> Weight {
        1_000_000_000
    }
    fn veto_external(_v: u32) -> Weight {
        1_000_000_000
    }
    fn cancel_referendum(_r: u32) -> Weight {
        1_000_000_000
    }
    fn cancel_queued(_r: u32) -> Weight {
        1_000_000_000
    }
    fn on_initialize_external(_r: u32) -> Weight {
        1_000_000_000
    }
    fn on_initialize_public(_r: u32) -> Weight {
        1_000_000_000
    }
    fn on_initialize_no_launch_no_maturing(_r: u32) -> Weight {
        1_000_000_000
    }
    ...
    fn clear_public_proposals(_p: u32) -> Weight {
        1_000_000_000
    }
    ...
    fn enact_proposal_execute(_b: u32) -> Weight {
        1_000_000_000
    }
    fn enact_proposal_slash(_b: u32) -> Weight {
        1_000_000_000
    }
}
...
mod weight_for {
    ...
    pub fn delegate<T: Trait>(votes: Weight) -> Weight {
        T::DbWeight::get()
            .reads_writes(votes.saturating_add(3), votes.saturating_add(3))
    ...
    pub fn undelegate<T: Trait>(votes: Weight) -> Weight {
        T::DbWeight::get()
            .reads_writes(votes.saturating_add(2), votes.saturating_add(2))
