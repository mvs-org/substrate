...
use frame_support::{
    ...
    traits::{
        Contains, EnsureOrigin, Filter, Get, Happened, IsDeadAccount, MigrateAccount,
        ModuleToIndex, OnKilledAccount, OnNewAccount, OriginTrait, StoredMap,
    },
...
impl WeightInfo for () {
    ...
    fn set_heap_pages(_i: u32) -> Weight {
        1_000_000_000
    }
    fn set_code_without_checks(_b: u32) -> Weight {
        1_000_000_000
    }
    fn set_changes_trie_config(_d: u32) -> Weight {
        1_000_000_000
    }
