...
use frame_support::{
    ...
    traits::{
        BalanceStatus, Currency, EnsureOrigin, Get, MigrateAccount, OnUnbalanced,
        ReservableCurrency,
    },
    weights::Weight,
};
...
impl WeightInfo for () {
    ...
    fn set_subs(_p: u32, _s: u32) -> Weight {
        1_000_000_000
    }
    ...
    fn add_sub(_p: u32) -> Weight {
        1_000_000_000
    }
    fn rename_sub() -> Weight {
        1_000_000_000
    }
    fn remove_sub(_p: u32) -> Weight {
        1_000_000_000
    }
    fn quit_sub(_p: u32) -> Weight {
        1_000_000_000
    }
}
...
mod weight_for {
    ...
    pub(crate) fn add_sub<T: Trait>(subs: Weight) -> Weight {
        let db = T::DbWeight::get();
    ...
    pub(crate) fn remove_sub<T: Trait>(subs: Weight) -> Weight {
        let db = T::DbWeight::get();
        db.reads_writes(4, 3) + 86_000_000 + 50_000 * subs
    }

    /// Weight calculation for `quit_sub`.
    pub(crate) fn quit_sub<T: Trait>(subs: Weight) -> Weight {
        let db = T::DbWeight::get();
