...
use authority_discovery_primitives::sr25519::AuthorityId as AuthorityDiscoveryId;
...
impl_runtime_apis! {
	...
	impl authority_discovery_primitives::AuthorityDiscoveryApi<Block, AccountId> for Runtime {
